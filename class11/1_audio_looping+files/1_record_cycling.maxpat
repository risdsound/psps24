...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1015.0, 187.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 102.0, 198.0, 24.0, 72.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 293.0, 408.0, 49.0, 22.0 ],
					"text" : "karma~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 409.0, 265.0, 20.0 ],
					"text" : "check out karma~ from Max's package manager"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 656.0, 378.0, 239.0, 20.0 ],
					"text" : "these loopers can record up to 10 seconds "
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 440.0, 5.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 359.0, 322.0, 20.0 ],
					"text" : "approx. \"I am sitting in a room\" process with RNBO loopers"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 490.0, 198.0, 49.0, 22.0 ],
					"text" : "norm 1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 235.0, 167.0, 29.0, 20.0 ],
					"text" : "rec "
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 589.0, 369.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "signal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 888.0, 369.0, 48.0, 136.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 423.0, 198.0, 49.0, 22.0 ],
					"text" : "norm 1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1041.0, 241.0, 47.0, 20.0 ],
					"text" : "stop all"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1015.0, 239.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 457.0, 146.0, 52.0, 22.0 ],
					"text" : "t b b b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "bang", "bang", "bang", "bang" ],
					"patching_rect" : [ 390.0, 146.0, 52.0, 22.0 ],
					"text" : "t b b b b"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 390.0, 4.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 390.0, 42.0, 69.0, 22.0 ],
					"text" : "metro 5000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 390.0, 72.0, 79.0, 22.0 ],
					"text" : "counter 0 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 213.0, 101.0, 69.0, 22.0 ],
					"text" : "0 0 0, 0 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 213.0, 167.0, 18.0, 34.0 ],
					"rows" : 2
				}
...
,
					"patching_rect" : [ 918.0, 300.0, 40.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 964.0, 273.0, 33.0, 22.0 ],
					"text" : "Stop",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 926.0, 273.0, 33.0, 22.0 ],
					"text" : "Play",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 888.0, 273.0, 33.0, 22.0 ],
					"text" : "Rec",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 888.0, 240.0, 110.0, 22.0 ],
					"text_width" : 64.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 888.0, 300.0, 110.0, 22.0 ],
					"text_width" : 64.0
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 570.0, 340.0, 78.0, 23.0 ],
									"rnbo_classname" : "set",
									"rnbo_serial" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 570.0, 310.0, 72.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 230.0, 820.0, 43.0, 23.0 ],
									"rnbo_classname" : "out~",
									"rnbo_extra_attributes" : 									{
										"comment" : "",
										"meta" : ""
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 160.0, 820.0, 43.0, 23.0 ],
									"rnbo_classname" : "out~",
									"rnbo_extra_attributes" : 									{
										"comment" : "",
										"meta" : ""
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 750.0, 410.0, 74.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"value" : 2.0,
										"ctlin" : 1.0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 400.0, 220.0, 109.0, 23.0 ],
									"rnbo_classname" : "expr",
									"rnbo_extra_attributes" : 									{
										"safemath" : 1,
										"hot" : 0
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 350.0, 660.0, 67.0, 23.0 ],
									"rnbo_classname" : "s",
									"rnbo_serial" : 5,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 750.0, 470.0, 109.000000000000114, 23.0 ],
									"rnbo_classname" : "sel",
									"rnbo_serial" : 2,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 350.0, 630.0, 24.0, 24.0 ],
									"rnbo_classname" : "button",
									"rnbo_serial" : 7,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 470.0, 390.0, 133.0, 37.0 ],
									"rnbo_classname" : "data",
									"rnbo_extra_attributes" : 									{
										"type" : "",
										"fill" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 390.0, 10.0, 121.0, 28.0 ],
									"text" : "modified"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 530.0, 820.0, 41.0, 18.0 ],
									"text" : "Params"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 430.0, 820.0, 27.0, 18.0 ],
									"text" : "Tips"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 494.0, 820.0, 32.0, 18.0 ],
									"text" : "Copy"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 460.0, 820.0, 30.0, 18.0 ],
									"text" : "Help"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 460.0, 840.0, 111.0, 18.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 740.0, 370.0, 100.0, 35.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 280.0, 820.0, 83.0, 21.0 ],
									"text" : "Audio out L/R",
									"textjustification" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 376.0, 632.0, 29.0, 21.0 ],
									"text" : "End",
									"textjustification" : 1
								}
...
,
					"patching_rect" : [ 888.0, 332.0, 124.499999999999943, 24.0 ],
					"rnboattrcache" : 					{
						"norm" : 						{
							"label" : "norm",
							"isEnum" : 0,
...
,
									"fileref" : 									{
										"name" : "Default[1]",
										"filename" : "Default[1]_20210710.maxsnap",
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "fedb536dbd973a267c8a9ebd975b256f"
									}
...
,
									"fileref" : 									{
										"name" : "Reverse",
										"filename" : "Default[1]_20210710_1.maxsnap",
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "89de10aef31121196dacfcb43fa4c053"
									}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 143.0, 234.0, 148.0, 22.0 ],
...
,
					"patching_rect" : [ 619.0, 300.0, 40.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 665.0, 273.0, 33.0, 22.0 ],
					"text" : "Stop",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 627.0, 273.0, 33.0, 22.0 ],
					"text" : "Play",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 589.0, 273.0, 33.0, 22.0 ],
					"text" : "Rec",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 589.0, 240.0, 110.0, 22.0 ],
					"text_width" : 64.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 589.0, 300.0, 110.0, 22.0 ],
					"text_width" : 64.0
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 390.0, 20.0, 121.0, 28.0 ],
									"text" : "modified"
								}
...
,
					"patching_rect" : [ 589.0, 332.0, 124.499999999999943, 24.0 ],
					"rnboattrcache" : 					{
						"norm" : 						{
							"label" : "norm",
							"isEnum" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 143.0, 161.0, 35.0, 22.0 ],
					"text" : "adc~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "signal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 589.0, 555.0, 48.0, 136.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 589.0, 734.0, 35.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-102" : [ "live.gain~[2]", "live.gain~", 0 ],
			"obj-16" : [ "live.gain~", "live.gain~", 0 ],
			"obj-43" : [ "rnbo~", "rnbo~", 0 ],
			"obj-70" : [ "rnbo~[1]", "rnbo~", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
