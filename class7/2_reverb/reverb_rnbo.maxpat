...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 230.0, 580.0, 34.0, 23.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 280.0, 220.0, 320.0, 16.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 230.0, 220.0, 35.0, 23.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 230.0, 260.0, 56.0, 23.0 ],
					"text" : "sfplay~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 50.0, 374.0, 110.0, 23.0 ],
					"text_width" : 64.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 50.0, 350.0, 110.0, 23.0 ],
					"text_width" : 64.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 50.0, 326.0, 110.0, 23.0 ],
					"text_width" : 64.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 50.0, 302.0, 110.0, 23.0 ],
					"text_width" : 64.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 50.0, 278.0, 110.0, 23.0 ],
					"text_width" : 64.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 50.0, 230.0, 110.0, 23.0 ],
					"text_width" : 64.0
				}
...
,
					"patching_rect" : [ 100.0, 190.0, 57.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 50.0, 190.0, 110.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 230.0, 420.0, 49.0, 103.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 380.0, 820.0, 70.0, 23.0 ],
									"rnbo_classname" : "send~",
									"rnbo_serial" : 1,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 630.0, 290.0, 64.0, 23.0 ],
									"rnbo_classname" : "send~",
									"rnbo_serial" : 2,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 60.0, 820.0, 77.0, 23.0 ],
									"rnbo_classname" : "send~",
									"rnbo_serial" : 3,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 630.0, 570.0, 64.0, 23.0 ],
									"rnbo_classname" : "send~",
									"rnbo_serial" : 4,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 380.0, 290.0, 75.0, 23.0 ],
									"rnbo_classname" : "send~",
									"rnbo_serial" : 5,
...
, 							{
						...
						"export_config" : 						{
							"max-export" : 							{
								"max-external-export" : 								{
									"description" : "Classic stereo artificial plate-reverb effect",
									"author" : "Cycling74",
									"external_name" : "rnbo.platereverb~",
...
,
							"cpp-export" : 							{
								"cpp-code-export" : 								{
									"export_name" : "rnbo.platereverb.cpp"
								}
...
,
							"web-export" : 							{
								"json-web-export" : 								{
									"file_name" : "rnbo.platereverb.json"
								}
...
,
					"patching_rect" : [ 230.0, 380.0, 79.0, 25.0 ],
					"rnboattrcache" : 					{
						"decay" : 						{
							"label" : "decay",
							"isEnum" : 0,
...
,
									"fileref" : 									{
										...
										"filepos" : -1,
										"snapshotfileid" : "779045dc228db3a920a3a2e671a822bc"
									}
...
,
									"fileref" : 									{
										...
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "91c679b487f1632c6b2b2981eb288047"
									}
...
,
									"fileref" : 									{
										...
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "4aa2a264c130483ac66ac903e459d3cc"
									}
...
,
									"fileref" : 									{
										...
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "664e619758a58b55682d1ee2bfa90f32"
									}
...
, 								{
									...
									"fileref" : 									{
										...
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "84b2dd50db6364e68373638d43d9b4d6"
									}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 50.0, 254.0, 110.0, 23.0 ],
					"text_width" : 64.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 0.0, 231.0, 21.0 ],
					"text" : "FROM C74: RNBO Guitar Pedals example"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 376.5, 18.0, 18.0 ],
					"text" : "6",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 352.5, 18.0, 18.0 ],
					"text" : "5",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 281.0, 18.0, 18.0 ],
					"text" : "2",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 328.5, 18.0, 18.0 ],
					"text" : "4",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 305.0, 19.0, 18.0 ],
					"text" : "3",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 256.5, 18.0, 18.0 ],
					"text" : "1",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 160.0, 304.5, 18.0, 18.0 ],
					"text" : "%",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 213.0, 110.0, 18.0 ],
					"text" : "Parameters",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 160.0, 376.5, 18.0, 18.0 ],
					"text" : "%",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 160.0, 352.5, 18.0, 18.0 ],
					"text" : "%",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 160.0, 329.0, 18.0, 18.0 ],
					"text" : "%",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 160.0, 280.5, 18.0, 18.0 ],
					"text" : "%",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 50.0, 421.0, 78.0 ],
					"text" : "This patch is a RNBO porting of the famous Yafr - \"Yet Another Free Reverb\" - reverberation patch originally designed by Randy Jones, which can be found in the Max examples. The Yafr algorithm was written \"in the syle of David Griesinger\" - a physicist who works in the field of sound and music, and is known for many reverberation algorithms behind famous reverb units."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 160.0, 257.0, 18.0, 18.0 ],
					"text" : "%",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 23.5, 162.0, 28.0 ],
					"text" : "RNBO PlateReverb"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 210.0, 30.0, 231.0, 21.0 ],
					"text" : "Classic stereo artificial plate-reverb effect"
				}
...
, 			{
				"name" : "Default[1]_20210325_3.maxsnap",
				"bootpath" : "~/Documents/Max 8/Snapshots",
				"patcherrelativepath" : "../../../../Max 8/Snapshots",
				"type" : "mx@s",
				"implicit" : 1
...
,
						"fileref" : 						{
							"name" : "Rnbo-PlateReverb",
							"filename" : "Rnbo-PlateReverb.maxsnap",
							"filepath" : "~/Documents/Max 8/Snapshots",
							"filepos" : -1,
							"snapshotfileid" : "14455977fa977eeace3348b9a8870f25"
						}
