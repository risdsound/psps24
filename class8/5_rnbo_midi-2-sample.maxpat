...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 14.0, 64.333333333333329, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 14.0, 39.666666666666664, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 16.0, 89.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 14.0, 15.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 160.0, 232.0, 40.0, 22.0 ],
					"text" : "midiin"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 59.0, 561.0, 35.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 62.0, 361.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 211.0, 232.0, 82.0, 22.0 ],
					"text" : "midiformat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 211.0, 190.0, 46.0, 22.0 ],
					"text" : "pack i i"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 211.0, 136.0, 108.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 211.0, 70.0, 336.0, 53.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 38.0, 114.0, 66.0, 23.0 ],
									"rnbo_classname" : "stripnote",
									"rnbo_serial" : 1,
									"rnbo_uniqueid" : "stripnote_obj-3",
									"text" : "stripnote"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "" ],
									"patching_rect" : [ 74.226799964904785, 388.5, 67.0, 23.0 ],
									"rnbo_classname" : "line~",
									"rnbo_serial" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 37.0, 215.0, 39.0, 19.0 ],
									"rnbo_classname" : "/",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 37.0, 192.0, 39.0, 19.0 ],
									"rnbo_classname" : "mtof",
									"rnbo_extra_attributes" : 									{
										"filter" : 1.0,
										"scalename" : ""
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 37.0, 170.0, 33.0, 19.0 ],
									"rnbo_classname" : "+",
									"rnbo_extra_attributes" : 									{
										"hot" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 37.0, 243.0, 30.0, 23.0 ],
									"rnbo_classname" : "t",
									"rnbo_extra_attributes" : 									{
										"triggers" : ""
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 540.0, 177.0, 304.0, 23.0 ],
...
,
									"text" : "param @name release @min 50 @max 5000 @value 250",
									"varname" : "release"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 492.0, 150.0, 277.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"fromnormalized" : "",
										"enum" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 436.0, 122.0, 283.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"fromnormalized" : "",
										"enum" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 375.166676640510559, 92.333335638046265, 285.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"fromnormalized" : "",
										"enum" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 331.666676104068756, 218.333339393138885, 41.0, 23.0 ],
									"rnbo_classname" : "/",
									"rnbo_extra_attributes" : 									{
										"hot" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "" ],
									"patching_rect" : [ 331.666676104068756, 263.0, 121.0, 23.0 ],
									"rnbo_classname" : "adsr~",
									"rnbo_serial" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 38.0, 659.0, 29.5, 23.0 ],
									"rnbo_classname" : "*~",
									"rnbo_serial" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 328.0, 62.0, 291.0, 23.0 ],
...
,
									"text" : "buffer~ @name source @channels 1 @file cvx_01.wav"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 38.0, 607.0, 279.0, 23.0 ],
...
,
									"text" : "groove~ @buffername source @channels 1 @loop 1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 74.226799964904785, 345.201033353805542, 50.0, 23.0 ],
...
,
					"patching_rect" : [ 59.0, 282.0, 120.0, 22.0 ],
					"rnboattrcache" : 					{
						"release" : 						{
							"label" : "release",
							"isEnum" : 0,
...
,
					"saved_object_attributes" : 					{
						...
						"parameter_enable" : 1,
						"polyphony" : 4,
						"uuid" : "1009ed1d-f902-11ee-ad1d-56757b2b74cf"
					}
,
					"snapshot" : 					{
...
,
							"__presetid" : "1009ed1d-f902-11ee-ad1d-56757b2b74cf",
							"attack" : 							{
								"value" : 20.0
							}
,
...
,
						"snapshotlist" : 						{
							...
							"entries" : [ 								{
									...
									"minorversion" : 0,
									"name" : "untitled",
									"origin" : "1009ed1d-f902-11ee-ad1d-56757b2b74cf",
									"type" : "rnbo",
									"subtype" : "",
									"embed" : 0,
									"snapshot" : 									{
...
,
									"fileref" : 									{
										"name" : "untitled",
										"filename" : "untitled_20240412.maxsnap",
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "133bca773609ff30c51fcb347a8f5b6d"
									}
...
,
		"dependency_cache" : [ 			{
				"name" : "cvx_01.wav",
				"bootpath" : "~/Documents/Students/___psps24/_wk8_041224/psps24-main/class8",
				"patcherrelativepath" : ".",
				"type" : "WAVE",
				"implicit" : 1
			}
, 			{
				"name" : "untitled_20240412.maxsnap",
